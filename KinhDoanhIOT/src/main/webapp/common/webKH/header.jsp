							...
							<div class="header__top__right">
								...
								<c:if test="${USERKHMODEL == null }">
									<div class="header__top__right__auth">
										<a href="/dichvu/khachhang-login.htm?action=login"><i class="fa fa-user"></i>
											Đăng nhập</a>
									</div>
								</c:if>
								<c:if test="${USERKHMODEL != null && USERKHMODEL.userName != null}">
									<div class="header__top__right__auth">
										<a href="#"><i class="fa fa-user"></i>Xin Chào ${USERKHMODEL.userName} </a>
					...
					<div class="col-lg-3">
						<div class="header__cart">
							<ul>
								...
								<li><a href="KH-giohang.htm"><i class="fa fa-shopping-bag"></i> <span id="myData">
											${slGioHang} </span></a></li>
							</ul>
						</div>
					</div>
