																...
																<c:forEach var="gh" items="${gioHangForm.gioHangs}"
																	...
																	<tr>
																		...
																		<td class="shoping__cart__item"><img
																			...
																			<h5>${spGioHang[status.index].ten}</h5>
																		</td>
																		...
																		<td class="shoping__cart__quantity">
																			<div class="quantity">
																				<div class="pro-qty">
																					<c:if
																						test="${spGioHang[status.index].slTon>0}">
																						<form:input
																							path="gioHangs[${status.index}].soLuong"
																							class="quality-input"
																							name="soLuong" id="soLuong"
																							onchange="tinhTongTien"
																							min="1"
																							max="${spGioHang[status.index].slTon}"
																							type="number" />
																					</c:if>
																					<c:if
																						test="${spGioHang[status.index].slTon<=0}">
																				...
																				<form:input
																					path="gioHangs[${status.index}].maSP"
																					name="maSP" id="maSP"
																					type="hidden" />
																				<form:input
																					path="gioHangs[${status.index}].ID"
																		...
																		<td id="totalPrice"
																			...
																			<span>${spGioHang[status.index].gia *
																				gh.soLuong}</span>
																		</td>
																		...
																		<c:if
																			...
																			<td class="shoping__cart__item__close">Sản
																				phẩm đã
																				hết hàng</td>
																		</c:if>
																	</tr>
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="shoping__checkout">
														...
														<button id="btnthanhtoan" type="submit" class="site-btn">Tiến
